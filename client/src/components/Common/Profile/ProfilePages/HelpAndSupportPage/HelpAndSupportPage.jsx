...
const HelpAndSupportPage = () => {
  ...
  const user = useSelector(
    (state) => state.auth?.user || state.user?.data || state.user
  );
              ...
              {searchQuery && filteredFaqs.length === 0 ? (
                <div className="text-center py-10">
                  <p className="text-lg text-gray-300">
                    No FAQs match your search query. Please try different
                    ...
                    <form onSubmit={handleContactSubmit} className="space-y-6">
                      ...
                      <div>
                        ...
                        >
                          ...
                          <option value="Account Questions">
                            Account Questions
                          </option>
...
const QuickLink = ({ title, icon }) => {
  return (
    ...
    >
      <div className="flex-shrink-0 text-purple-600 dark:text-purple-400 mr-3">
        {icon}
      </div>
...
const guides = [
  {
    ...
    description:
      "Learn the basics of navigating our platform and setting up your account for success.",
    link: "#",
    icon: (
      <svg
        className="h-6 w-6"
  ...
  },
  {
    ...
    description:
      "Discover effective bidding techniques to increase your chances of winning auctions.",
    link: "#",
    icon: (
      <svg
        className="h-6 w-6"
  ...
  },
  {
    ...
    description:
      "Everything you need to know about completing payments and shipping arrangements.",
    link: "#",
    icon: (
      <svg
        className="h-6 w-6"
  ...
  },
  {
    ...
    description:
      "Learn how to effectively list and sell your items on our auction platform.",
    link: "#",
    icon: (
      <svg
        className="h-6 w-6"
  ...
  },
  {
    ...
    description:
      "Understand how our experts authenticate items to ensure quality and authenticity.",
    link: "#",
    icon: (
      <svg
        className="h-6 w-6"
  ...
  },
  {
    ...
    description:
      "How to resolve issues with transactions, bidding, or item conditions.",
    link: "#",
    icon: (
      <svg
        className="h-6 w-6"
