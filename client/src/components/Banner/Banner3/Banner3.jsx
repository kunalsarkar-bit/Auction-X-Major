  ...
  useEffect(() => {
    const fetchBanners = async () => {
      try {
        ...
        // Filter products that have banner images and map to required format
        const formattedBanners = products
          .filter((product) => product?.bannerImage?.secure_url)
          .map((product) => ({
            id: product._id,
            url: product.bannerImage.secure_url,
            author: product.name,
