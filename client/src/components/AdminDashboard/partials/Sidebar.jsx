            ...
            <ul className="mt-3">
                        ...
                        <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="https://www.instagram.com/auctionx_official/"
                              className={({ isActive }) =>
                                "block transition duration-150 truncate " +
                                (isActive
                                  ? "text-violet-500"
                            ...
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200"></span>
                            </NavLink>
                          </li>
                          <li className="mb-1 last:mb-0">
                            <NavLink
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="https://www.facebook.com/people/Auction-X-Official/61572131243624/?rdid=pwhisJVcebDoJiii&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F15nxmDHcJ6%2F"
                              className={({ isActive }) =>
                                "block transition duration-150 truncate " +
                                (isActive
                                  ? "text-violet-500"
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="https://www.whatsapp.com/channel/0029Vb2uMkh6buMFgEoiP013"
                              className={({ isActive }) =>
                                "block transition duration-150 truncate " +
                                (isActive
                                  ? "text-violet-500"
                        ...
                        <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="/admin/dashboard/sellerHistory"
                              className={({ isActive }) =>
                                "block transition duration-150 truncate " +
                                (isActive
                                  ? "text-violet-500"
                        ...
                        <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="/admin/dashboard/customEvents"
                              className={({ isActive }) =>
                                "block transition duration-150 truncate " +
                                (isActive
                                  ? "text-violet-500"
              ...
              >
                <NavLink
                  ...
                  to="/admin/dashboard/privacy-requests"
                  className={`block text-gray-800 dark:text-gray-100 truncate transition duration-150 ${
                    pathname.includes("messages")
                      ? ""
                      : "hover:text-gray-900 dark:hover:text-white"
                        ...
                        <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="/admin/dashboard/settings/myAccount"
                              className={({ isActive }) =>
                                "block transition duration-150 truncate " +
                                (isActive
                                  ? "text-violet-500"
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="/admin/dashboard/settings/myNotifications"
                              className={({ isActive }) =>
                                "block transition duration-150 truncate " +
                                (isActive
                                  ? "text-violet-500"
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="/admin/dashboard/settings/addAdmin"
                              className={({ isActive }) =>
                                "block transition duration-150 truncate " +
                                (isActive
                                  ? "text-violet-500"
                          ...
                          <li className="mb-1 last:mb-0">
                            <button
                              ...
                              className="cursor-pointer block w-full text-left transition duration-150 truncate text-gray-500/90 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200"
                            >
                              <span className="text-sm font-medium lg:opacity-0 lg:sidebar-expanded:opacity-100 2xl:opacity-100 duration-200">
                                Logout
                              </span>
                        ...
                        <ul className={`pl-8 mt-1 ${!open && "hidden"}`}>
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="/admin/dashboard/utility/adminLogs"
                              className={({ isActive }) =>
                                "block transition duration-150 truncate " +
                                (isActive
                                  ? "text-violet-500"
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="/admin/dashboard/utility/roadmap"
                              className={({ isActive }) =>
                                "block transition duration-150 truncate " +
                                (isActive
                                  ? "text-violet-500"
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="/admin/dashboard/utility/faq"
                              className={({ isActive }) =>
                                "block transition duration-150 truncate " +
                                (isActive
                                  ? "text-violet-500"
                          ...
                          <li className="mb-1 last:mb-0">
                            <NavLink
                              ...
                              to="/admin/dashboard/utility/downloadDataExcel"
                              className={({ isActive }) =>
                                "block transition duration-150 truncate " +
                                (isActive
                                  ? "text-violet-500"
